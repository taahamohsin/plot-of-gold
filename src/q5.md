...
chart.append("g").attr("transform", `translate(0, ${innerHeight})`).call(d3.axisBottom(x_scale).ticks(5, ".1s")).selectAll("text").style("fill", "#e0e0e0");

chart.append("g").call(d3.axisLeft(y_scale)).selectAll("text").style("fill", "#e0e0e0");
...
legend.append("text").attr("x", 0).attr("y", 0).text("Region Codes").style("font-weight", "600").style("font-size", "16px").style("fill", "#f0f0f0");
...
Object.entries(regionMap).forEach(([code, name], i) => {
    ...
    row.append("text").attr("x", 15).attr("y", 0).text(`${code}: ${name}`).style("font-size", "13px").style("fill", "#e0e0e0").attr("alignment-baseline", "middle");
});
...
chart2.append("g").attr("transform", `translate(0, ${innerHeight2})`).call(d3.axisBottom(x_scale2)).selectAll("text").style("fill", "#e0e0e0");
chart2.append("g").call(d3.axisLeft(y_scale2)).selectAll("text").style("fill", "#e0e0e0");
...
legend2.append("text").attr("x", 0).attr("y", 0).text("Region Codes").style("font-weight", "600").style("font-size", "16px").style("fill", "#f0f0f0");
