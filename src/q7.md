...
const circles = chart.selectAll('circle')
    ...
    .on("mouseover", function(event, d) {
        ...
        // Extract simple name for display (e.g., "Inflation" from "inflation, consumer prices...")
        const simpleName = selectedOption.split("(")[0].trim(); // Simple heuristic or use a map
